...
{
    /// <inheritdoc />
    public partial class AgregarCamposLealtadYMejorasPaquetes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalComprasHistoricas = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
                    NivelDescuento = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescripcionDetallada = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ...
                    RutaImagenPrincipal = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    PlazasDisponibles = table.Column<int>(type: "int", nullable: false, defaultValue: 20),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Titulo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: ""),
                    ...
                    PaqueteTuristicoId = table.Column<int>(type: "int", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Opiniones", x => x.Id);
                    table.CheckConstraint("CK_Opinion_Calificacion", "[Calificacion] >= 1 AND [Calificacion] <= 5");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Opiniones_PaquetesTuristicos_PaqueteTuristicoId",
                        column: x => x.PaqueteTuristicoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservas_PaquetesTuristicos_PaqueteTuristicoId",
                        column: x => x.PaqueteTuristicoId,
                        principalTable: "PaquetesTuristicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Opiniones_PaqueteTuristicoId",
                table: "Opiniones",
                column: "PaqueteTuristicoId");

            migrationBuilder.CreateIndex(
                name: "IX_PaquetesTuristicos_Tags",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservas_PaqueteTuristicoId",
                table: "Reservas",
                column: "PaqueteTuristicoId");
        }
